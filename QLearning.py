...
class QLearning(object):
    ...
    def __init__(self, colLen, rowLen, actionLen, qTableFileName=None, learning_rate=0.01, reward_decay=0.9, eps=0.9):
    ...
    def choose_action(self, observation):
        ...
        if len(maxActions) > 1 :
            ...
            pass
        return action
    def epsGreedySearch(self, observation):
